...
@section('title', 'Editar Filiado - ' . $filiado->nome)
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center bg-white border-bottom-0 pt-3 pb-0">
                    <h3 class="card-title mb-0 h5 text-warning">
                        <i class="fas fa-user-edit me-2"></i>Editar Filiado: {{ $filiado->nome }}
                    </h3>
                    <div class="card-tools">
                        <a href="{{ route('filiados.show', $filiado->id) }}" class="btn btn-info btn-sm">
                ...
                <form action="{{ route('filiados.update', $filiado->id) }}" 
                      method="POST" 
                      enctype="multipart/form-data" 
                      id="formEditarFiliado">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        {{-- ✨ PREVIEW DE FOTO - ESTILO REDE SOCIAL --}}
                        <div class="row mb-4">
                            <div class="col-12 text-center">
                                <div class="avatar-edit-container">
                                    <div class="avatar-preview-wrapper" 
                                         id="avatarWrapper"
                                         title="Clique na foto para alterar"
                                    ...
                                    <p class="mt-2 mb-0 text-muted small">
                                        <i class="fas fa-info-circle me-1"></i>Clique na foto ou no ícone <strong>📷</strong> para alterar
                                    </p>
                                </div>
                                ...
                                <div id="arquivoNome" class="mt-2 text-muted small">
                                    @if($filiado->arquivo)
                                        ...
                                        <strong>Arquivo atual:</strong> {{ basename($filiado->arquivo) }}
                                        <br><small>Envie um novo arquivo para substituir</small>
                                    @else
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="matricula" id="matricula"
                                       ...
                                       value="{{ old('matricula', $filiado->matricula) }}" required>
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" name="nome" id="nome"
                                       ...
                                       value="{{ old('nome', $filiado->nome) }}" required
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="nome_carteira" id="nome_carteira"
                                       ...
                                       value="{{ old('nome_carteira', $filiado->nome_carteira) }}"
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                                    <option value="ativo" {{ old('status', $filiado->status) == 'ativo' ? 'selected' : '' }}>✅ Ativo</option>
                                    <option value="inativo" {{ old('status', $filiado->status) == 'inativo' ? 'selected' : '' }}>❌ Inativo</option>
                                    <option value="transferido" {{ old('status', $filiado->status) == 'transferido' ? 'selected' : '' }}>🔄 Transferido</option>
                                </select>
                                        ...
                                        <select name="congregacao_id" id="congregacao_id"
                                            ...
                                            @foreach($congregacoes as $congregacao)
                                                <option value="{{ $congregacao->id }}"
                                                    {{ old('congregacao_id', $filiado->congregacao_id) == $congregacao->id ? 'selected' : '' }}>
                                ...
                                @elseif(auth()->user()->isSecretario())
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <small class="form-text text-muted">
                                            <i class="fas fa-info-circle me-1"></i>Secretários só podem gerenciar sua congregação
                                        </small>
                                    </div>
                                @else
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="funcao" id="funcao" class="form-select @error('funcao') is-invalid @enderror" required>
                                    <option value="">Selecione...</option>
                                    <option value="Membro" {{ old('funcao', $filiado->funcao) == 'Membro' ? 'selected' : '' }}>Membro</option>
                                    <option value="Diácono" {{ old('funcao', $filiado->funcao) == 'Diácono' ? 'selected' : '' }}>Diácono</option>
                                    <option value="Presbítero" {{ old('funcao', $filiado->funcao) == 'Presbítero' ? 'selected' : '' }}>Presbítero</option>
                                    <option value="Missionário" {{ old('funcao', $filiado->funcao) == 'Missionário' ? 'selected' : '' }}>Missionário</option>
                                    @if(auth()->user()->isAdmin())
                                        <option value="Secretário" {{ old('funcao', $filiado->funcao) == 'Secretário' ? 'selected' : '' }}>🔐 Secretário</option>
                                    @endif
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="estadoCivil" id="estadoCivil" class="form-select @error('estadoCivil') is-invalid @enderror" required>
                                    <option value="">Selecione...</option>
                                    <option value="Solteiro" {{ old('estadoCivil', $filiado->estadoCivil) == 'Solteiro' ? 'selected' : '' }}>Solteiro(a)</option>
                                    <option value="Casado" {{ old('estadoCivil', $filiado->estadoCivil) == 'Casado' ? 'selected' : '' }}>Casado(a)</option>
                                    <option value="Divorciado" {{ old('estadoCivil', $filiado->estadoCivil) == 'Divorciado' ? 'selected' : '' }}>Divorciado(a)</option>
                                    <option value="Viúvo" {{ old('estadoCivil', $filiado->estadoCivil) == 'Viúvo' ? 'selected' : '' }}>Viúvo(a)</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="user_id" id="user_id" 
                                    ...
                                    @foreach(\App\Models\User::where('nivel', 'user')->orderBy('name')->get() as $usr)
                                        <option value="{{ $usr->id }}" 
                                            {{ old('user_id', $filiado->user_id) == $usr->id ? 'selected' : '' }}>
                                            {{ $usr->name }} ({{ $usr->email }})
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row g-3 mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mae" id="mae" class="form-control @error('mae') is-invalid @enderror"
                                       value="{{ old('mae', $filiado->mae) }}" required>
                        ...
                        <div class="row g-3 mt-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="documento" id="documento" class="form-control @error('documento') is-invalid @enderror"
                                       value="{{ old('documento', $filiado->documento) }}" placeholder="000.000.000-00" maxlength="14" required>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="telefone" id="telefone" class="form-control @error('telefone') is-invalid @enderror"
                                       value="{{ old('telefone', $filiado->telefone) }}" placeholder="(00) 00000-0000" maxlength="15" required>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror"
                                       value="{{ old('email', $filiado->email) }}" placeholder="exemplo@email.com">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="dataNascimento" id="dataNascimento" class="form-control @error('dataNascimento') is-invalid @enderror"
                                       value="{{ old('dataNascimento', $filiado->dataNascimento ? date('Y-m-d', strtotime($filiado->dataNascimento)) : '') }}" required>
                        ...
                        <div class="row g-3 mt-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    <input type="text" name="cep" id="cep" class="form-control @error('cep') is-invalid @enderror"
                                           value="{{ old('cep', $filiado->cep) }}" placeholder="00000-000" maxlength="9" required>
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="logradouro" id="logradouro" class="form-select @error('logradouro') is-invalid @enderror" required>
                                    <option value="Rua" {{ old('logradouro', $filiado->logradouro) == 'Rua' ? 'selected' : '' }}>Rua</option>
                                    <option value="Avenida" {{ old('logradouro', $filiado->logradouro) == 'Avenida' ? 'selected' : '' }}>Avenida</option>
                                    <option value="Praça" {{ old('logradouro', $filiado->logradouro) == 'Praça' ? 'selected' : '' }}>Praça</option>
                                    <option value="Travessa" {{ old('logradouro', $filiado->logradouro) == 'Travessa' ? 'selected' : '' }}>Travessa</option>
                                    <option value="Estrada" {{ old('logradouro', $filiado->logradouro) == 'Estrada' ? 'selected' : '' }}>Estrada</option>
                                    <option value="Sítio" {{ old('logradouro', $filiado->logradouro) == 'Sítio' ? 'selected' : '' }}>Sítio</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="endereco" id="endereco" class="form-control @error('endereco') is-invalid @enderror"
                                       value="{{ old('endereco', $filiado->endereco) }}" required placeholder="Preenchido pelo CEP">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="numero" id="numero" class="form-control @error('numero') is-invalid @enderror"
                                       value="{{ old('numero', $filiado->numero) }}" required placeholder="Ex: 123 ou S/N">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="bairro" id="bairro" class="form-control @error('bairro') is-invalid @enderror"
                                       value="{{ old('bairro', $filiado->bairro) }}" required>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="cidade" id="cidade" class="form-control @error('cidade') is-invalid @enderror"
                                       value="{{ old('cidade', $filiado->cidade) }}" required>
                            ...
                            <div class="col-md-1">
                                ...
                                <select name="uf" id="uf" class="form-select @error('uf') is-invalid @enderror" required>
                                    ...
                                    @foreach(['AC','AL','AP','AM','BA','CE','DF','ES','GO','MA','MT','MS','MG','PA','PB','PR','PE','PI','RJ','RN','RS','RO','RR','SC','SP','SE','TO'] as $estado)
                                        <option value="{{ $estado }}" {{ old('uf', $filiado->uf) == $estado ? 'selected' : '' }}>{{ $estado }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row g-3 mt-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="datCadastro" id="datCadastro" class="form-control @error('datCadastro') is-invalid @enderror"
                                       value="{{ old('datCadastro', $filiado->datCadastro ? date('Y-m-d', strtotime($filiado->datCadastro)) : date('Y-m-d')) }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="dataBatismo" id="dataBatismo" class="form-control @error('dataBatismo') is-invalid @enderror"
                                       value="{{ old('dataBatismo', $filiado->dataBatismo ? date('Y-m-d', strtotime($filiado->dataBatismo)) : '') }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="data_Consagracao" id="data_Consagracao" class="form-control @error('data_Consagracao') is-invalid @enderror"
                                       value="{{ old('data_Consagracao', $filiado->data_Consagracao ? date('Y-m-d', strtotime($filiado->data_Consagracao)) : '') }}">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-success mb-2 py-1">
                                    <i class="fas fa-paperclip me-1"></i><strong>Arquivo atual:</strong> 
                                    <a href="{{ Storage::url($filiado->cartas) }}" target="_blank" class="alert-link">Visualizar carta atual</a>
                                    <br><small class="text-muted"><i class="fas fa-info-circle me-1"></i>Envie um novo arquivo para substituir.</small>
                                </div>
                                @endif
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="alert alert-secondary mb-0">
                                    <i class="fas fa-history me-1"></i><strong>Informações do sistema:</strong>
                                    Cadastrado por {{ $filiado->user->name ?? 'N/A' }} em {{ $filiado->created_at?->format('d/m/Y H:i:s') ?? 'N/A' }}
                                    @if($filiado->updated_at && $filiado->updated_at != $filiado->created_at)
                                        · Última atualização: {{ $filiado->updated_at->format('d/m/Y H:i:s') }}
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer d-flex gap-2">
                        <button type="submit" class="btn btn-primary" id="btnSubmit">
                            <i class="fas fa-save me-1"></i><span id="btnSubmitText">Atualizar Filiado</span>
                        </button>
                        <a href="{{ route('filiados.show', $filiado->id) }}" class="btn btn-info">
                            <i class="fas fa-eye me-1"></i>Visualizar
                        </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.showAlert = function(type, message) {
        ...
        alert.role = 'alert';
        // ✅ Bootstrap 5: btn-close + data-bs-dismiss
    ...
    const form = document.getElementById('formEditarFiliado');
    if (form) {
...
<style>
    ...
    .avatar-edit-btn { position: absolute; bottom: 5px; right: 5px; width: 32px; height: 32px; background: #0D8ABC; color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.9rem; box-shadow: 0 2px 8px rgba(0,0,0,0.2); transition: background 0.2s ease, transform 0.2s ease; cursor: pointer; z-index: 20; pointer-events: auto; }
    .avatar-edit-btn:hover { background: #0a6a94; transform: scale(1.1); }
